...
import planet.it.limited.pepsigosmart.activities.OfflineDataAct;
...
public class OfflineDataSendToServer {
    Context mContext;
    ...
    public OfflineDataSendToServer(Context context, AppCompatActivity appCompatActivity){
                                ...
                                ((Activity) mContext).runOnUiThread(new Thread(new Runnable() {
                                    public void run() {
                                       ...
                                       // appCompatActivity.finish();
                                        Intent intent = new Intent(mContext, OfflineDataAct.class);
