package planet.it.limited.pepsigosmart.services;
    ...
    private Location getLocation() {
        ...
        try {
            ...
            if (!checkGPS && !checkNetwork) {
                ...
                if (checkNetwork) {
//                    Toast.makeText(mContext, "Getting location... please wait...", Toast.LENGTH_SHORT).show();
